...
Los números de las tablas (métricas, top-10, sensibilidad, progresión) provienen literalmente de `data/processed/*.csv` y deben regenerarse junto con esos CSV (`make all`).
